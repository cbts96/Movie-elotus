import { GET_UC_LIST_FILM } from "../actions/type/FilmType";
...
export const filmUCReducer = (state=stateDefault,action ) => {
    switch(action.type) {

        case GET_UC_LIST_FILM : {
            state.arrUCFilm = action.arrUCFilm;

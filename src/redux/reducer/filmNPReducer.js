import { GET_NP_LIST_FILM } from "../actions/type/FilmType";
...
export const filmNPReducer = (state=stateDefault,action ) => {
    switch(action.type) {

        case GET_NP_LIST_FILM : {
            state.arrNPFilm = action.arrNPFilm;
            // state.arrFilmDefault = state.arrNPFilm;
            return {...state}
        }
    default:
      return { ...state };
